...
\begin{objectionbox}[title={\sffamily\bfseries\small\color{C@warning}
  Objection 5 (US): ``\textit{Glucksberg} forecloses the constitutional argument''}]
...
removal. The factual premise the rational basis rests on is a legal fiction.
\end{objectionbox}

\medskip

\begin{objectionbox}[title={\sffamily\bfseries\small\color{C@warning}
  Objection 4: ``It contradicts the sanctity of life''}]
...
\textbf{Key Sources:} Health Canada, \textit{Sixth Annual Report on MAiD} (2025);
